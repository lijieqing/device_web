...
public class PGN {
	...
	public PGN(String deviceNum, String pgnNum, String pgnDir, String pgnLen,
			String pgnPrio, String pgnRate, String pgnReq, String pgnReqcyc,
			String pgnSa, String pgnGroupSp, String pgnType) {
		super();
		this.pgnId = null;
		...
		this.pgnDir = pgnDir;
		this.pgnLen = pgnLen;
		this.pgnPrio = pgnPrio;
		this.pgnRate = pgnRate;
		this.pgnReq = pgnReq;
		this.pgnReqcyc = pgnReqcyc;
		this.pgnSa = pgnSa;
		this.pgnGroupSp = pgnGroupSp;
		this.pgnType = pgnType;
	}
    ...
    public String getPgnGroupSp() {
        return pgnGroupSp;
    }

    public void setPgnGroupSp(String pgnGroupSp) {
        this.pgnGroupSp = pgnGroupSp == null ? null : pgnGroupSp.trim();
    }
